...
<html>
<head>
	<title>Register | Peminjaman Barang Inventarisasi Laboratorium D3 Teknologi Komputer</title>
...
<body  style="background-image: url('background.jpg') !important;">
	<div class="container">
		<div class='row'>
			...
			<div class="col-md-4 form-register-container">
				...
				<form action="" method="post">
					...
					<label >NIM</label>
					<input class="form-control" type="" name="nim" required>
					...
					<input class="form-control" type="" name="MobilePhone" required>
					<label>Kelas/Jabatan</label>
					<input class="form-control"type="" name="level" required><br>
					<input type="checkbox" name="" required> Saya setuju dengan syarat dan ketentuan
