<?php
	...
	if(isset($_POST['request-pinjam'])){
		...
		$query_insert_req   = mysqli_query($connect, "INSERT INTO tbl_request (nama_barang, peminjam, level, jml_barang, tgl_pinjam, tgl_kembali) VALUES ('$nama_barang', '$username', '$level', '$jml_barang', '$tgl_pinjam', '$tgl_kembali')");
		if($query_insert_req){
